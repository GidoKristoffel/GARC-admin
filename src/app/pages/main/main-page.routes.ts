...
export const mainPage: Routes = [
  {
    ...
    loadChildren: () =>
      import('./accounts/accounts.routes').then((r) => r.accountsPage),
  },
  {
    ...
    loadChildren: () =>
      import('./characters/characters.routes').then((r) => r.charactersPage),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./materials/materials.component').then(
        (c) => c.MaterialsComponent,
      ),
    loadChildren: () =>
      import('./materials/materials.routes').then((r) => r.materialsRoutes),
  },
  {
    path: EPage.Enemies,
    loadComponent: () =>
      import('./enemies/enemies.component').then((c) => c.EnemiesComponent),
    loadChildren: () =>
