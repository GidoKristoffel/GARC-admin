...
export class CharactersPlayableService {
  ...
  public getCharacterById(id: string, callback: (character: IPlayableCharacter) => void): void {
  ...
  public updateCharacter(id: string, form: FormGroup<ICharacterFormBuilder>, detailsLink: string): void {
